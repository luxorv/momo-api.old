...
RSpec.describe OtakusController, :type => :routing do
  describe "routing" do
    ...
    it "routes to lists" do
      ...
      expect(:delete => "/otakus/1/watch").to route_to("otakus#remove_from_watch_list", :id => "1")
      expect(:delete => "/otakus/1/watched").to route_to("otakus#remove_from_watched_list", :id => "1")
      expect(:delete => "/otakus/1/watching").to route_to("otakus#remove_from_watching_list", :id => "1")
    end
